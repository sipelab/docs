...
relatives:
  - "[[Widefield Setup/Software Packages/Napari|Napari]]"
  - "[[pymmcore-plus]]"
  - "[[Arduino]]"
  - "[[Dhyana 400BSI V2]]"
---
...
[Integration](https://micro-manager.org/Using_the_Micro-Manager_python_library) with [[PycroManager]] and [[pymmcore-plus]] and [[Widefield Setup/Software Packages/Napari|Napari]]
